...
public class LiveMatchUpdator extends AppCompatActivity {

    ListView listView;
    String [] countryname=new String[]{"Archery","Badminton","Basketball","Carrom","Chess","Fencing","Football","Handball","Hockey","Kabaddi","Kho Kho","Rowing","Table Tennis","Volleyball"};
    Spinner spinner;
    String TAG="Pratik";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_match_updator);
...
//                                                                                                TeamBScore.setText("");
                                                                                                ...
                                                                                                Intent intent=new Intent(LiveMatchUpdator.this,ScoreUpdation.class);
                                                                                                intent.putExtra("Category", Category.getText().toString());
                                                                                                intent.putExtra("EventName", EventName.getText().toString());
                                                                                                intent.putExtra("MatchNo", MatchNo.getText().toString());
                                                                                                startActivity(intent);
                                                                                            }
                                                                                        }).addOnFailureListener(new OnFailureListener() {
                                                                                            @Override
                                                                                            public void onFailure(@NonNull Exception e) {
                                                                                                Log.d(TAG, "Falied Score");
                                                                                            }
                                                                                        });
