...
public class UpcomingUpdator extends AppCompatActivity {
    ...
    Spinner spinner;
    String TAG="Pratik";
    EditText Category,Date,Time,MatchNo,TeamA,TeamB;
    TextView EventName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upcoming_updator);
